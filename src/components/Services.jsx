          ...
          {services.length > 0 ? (
            ...
            <>
              <motion.div className="service-card" whileHover={{ y: -10 }}>
                <img src="https://i.pinimg.com/736x/9c/5f/2b/9c5f2b032c561377ba8d7524045e4c19.jpg" alt="Bridal Makeup" />
                <div className="service-info">
                  <h3>Bridal Makeup</h3>
...
<motion.div className="service-card" whileHover={{ y: -10 }}>
                <img src="https://bridal-makeup.in/images/spsimpleportfolio/bridal-makeup-all/low-res/engagement-bridal-makeup-kalyan.webp" alt="Engagement Makeup" />
                <div className="service-info">
                  <h3>Engagement Makeup</h3>
                  <p>HD makeup with natural glowing look - includes hairstyle, colored lenses & eyelashes</p>
