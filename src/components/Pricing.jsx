...
function Pricing({ services = [] }) {
  const defaultServices = [
    ...
    { id: 2, name: 'Engagement Makeup', price: 8000, offer: true },
  ...
  const displayServices = services.length > 0 
    ? services.map(s => ({ ...s, popular: s.name === 'Bridal Makeup', offer: s.name === 'Pre-Bridal Package' || s.name === 'Engagement Makeup' }))
    : defaultServices;
