...
{ name: 'Engagement Makeup', price: 8000, description: 'HD makeup with natural glowing look - includes hairstyle, colored lenses & eyelashes', image: 'https://bridal-makeup.in/images/spsimpleportfolio/bridal-makeup-all/low-res/engagement-bridal-makeup.webp' },
...
{ name: 'Facial & Skin Treatment', price: 3500, description: 'Rejuvenating facial and skin treatments', image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=400' },
    { name: 'Airbrush Makeup', price: 4500, description: 'Flawless airbrush makeup for a smooth, camera-ready finish', image: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=400' },
  ];
...
// Run directly via `node seed.js` (or `npm run seed`)
