...
function AdminDashboard({ bookings = [], services = [], updateBookingStatus, updateService, addService, deleteService }) {
  ...
  const demoBookings = [
    { id: 'id1', name: 'Priya Sharma', phone: '+91 98765 43210', service: 'Bridal Makeup', date: '2024-12-15', time: '10:00 AM', price: 15000, status: 'pending' },
    { id: 'id2', name: 'Anjali Patel', phone: '+91 98765 43211', service: 'Engagement Makeup', date: '2024-12-20', time: '11:00 AM', price: 8000, status: 'approved' },
    { id: 'id3', name: 'Riya Khan', phone: '+91 98765 43212', service: 'Party Makeup', date: '2024-12-25', time: '02:00 PM', price: 3000, status: 'pending' },
    // 2026 Pending Requests
    { id: 'id4', name: 'Meera Singh', phone: '+91 98765 43213', service: 'Bridal Makeup', date: '2026-01-15', time: '10:00 AM', price: 15000, status: 'pending' },
    { id: 'id5', name: 'Neha Verma', phone: '+91 98765 43214', service: 'HD Makeup', date: '2026-02-20', time: '11:00 AM', price: 10000, status: 'pending' },
    { id: 'id6', name: 'Kavita Reddy', phone: '+91 98765 43215', service: 'Engagement Makeup', date: '2026-03-10', time: '02:00 PM', price: 8000, status: 'pending' },
    { id: 'id7', name: 'Sneha Gupta', phone: '+91 98765 43216', service: 'Pre-Bridal Package', date: '2026-04-05', time: '09:00 AM', price: 12000, status: 'pending' },
    { id: 'id8', name: 'Ananya Kapoor', phone: '+91 98765 43217', service: 'Party Makeup', date: '2026-05-18', time: '03:00 PM', price: 3000, status: 'pending' },
  ];

  const [localBookings, setLocalBookings] = useState(bookings.length > 0 ? bookings : demoBookings);
  ...
  const handleStatusUpdate = (bookingId, newStatus) => {
    // If local fallback mode (starts with 'id' or 'local_'), update locally
    if (typeof bookingId === 'string' && (bookingId.startsWith('id') || bookingId.startsWith('local_'))) {
                ...
                <div key={service.id} className="service-card">
                  ...
                  <div className="service-info">
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem' }}>
                      ...
                      <button 
                        onClick={() => deleteService && deleteService(service.id)}
                        style={{
                          flex: 1,
                          padding: '0.5rem',
                          background: '#DC3545',
